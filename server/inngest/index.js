...
export const inngest = new Inngest({ id: "teamon" });
...
//Inngest functionto save workspace data to a database
const syncWorkspaceCreation = inngest.createFunction(
  { id: "sync-workspace-from-clek" },
  ...
  async ({ event, step }) => {
    ...
    await sendEmail({
      ...
      body: `<div style="max-width: 600px;">
            ...
            <p style="font-size: 16px;">You've beeen assigned a new task:</p>
            ...
            <p style="margin-top: 20px; font-size: 14px; color: #6c757d;">Please make sure to review and complete it before the due data.</p>
