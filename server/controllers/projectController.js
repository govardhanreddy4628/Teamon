...
export const createProject = async (req, res) => {
    try {
        ...
        const { workspaceId, description, name, status, start_date,
            end_date, team_members, team_lead, progress, priority
        } = req.body;
        ...
        const project = await prisma.project.create({
            data: {
                ...
                end_date: end_date ? newDate(end_date) : null,
            }
        })
...
export const updateProject = async (req, res) => {
    try {
        ...
        res.json({ project, message: error.code || error.message })
...
export const addMember = async (req, res) => {
    try {
        ...
        const membe = await prisma.projectMember.create({
            data: {
                userId: user.id,
                projectId
            }
